...
// Résout l'id_tresorier (FK requise par Paiement) pour l'utilisateur qui
// enregistre un paiement. Seul un utilisateur ayant réellement un profil
// Tresorier en possède un ; un président/moniteur enregistrant un paiement
// n'en a pas forcément (Paiement.id_tresorier est nullable pour ce cas).
...
// même logique réutilisée pour Adhesion et Formation.
