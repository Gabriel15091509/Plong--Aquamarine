...
// logique des données de finance-service par rapport au reste — voir
...
const sequelize = new Sequelize(
  ...
  process.env.DB_PASSWORD,
  {
    ...
    // explicitement son propre `schema` (voir models/Paiement.js) — c'est ce
    ...
    searchPath: process.env.DB_SCHEMA || "finance",
