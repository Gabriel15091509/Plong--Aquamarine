...
// input syntax for type integer: ''", "for type numeric: ''"...).
// Normalisé ici, au point d'entrée commun à tous les create/update de ce
// service, plutôt que dans chaque service pris isolément.
