...
// ✅ Configuration des statuts de certificats
...
const CertificatsPage = () => {
  ...
  const stats = useMemo(() => {
    ...
    const valides = certificats.filter((c) => c.statut === "Valide").length;
    const expires = certificats.filter((c) => c.statut === "Expiré").length;
    const enAttente = certificats.filter(
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <FiHeart className="w-4 h-4 text-blue-600 dark:text-blue-400" />
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
              {stats.total} certificats
            </span>
          </div>
